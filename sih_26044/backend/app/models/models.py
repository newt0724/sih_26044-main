...
class Job(Base):
    ...
    company_rating_reason = Column(Text, nullable=True)
    company_rating_updated_by = Column(Integer, nullable=True)
    company_rating_updated_at = Column(DateTime, nullable=True)
